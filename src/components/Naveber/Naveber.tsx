        ...
        <div className='hidden md:block w-full mx-auto'>
            <div className='w-full h-[80px] flex text-textColor justify-between items-center'>
                ...
                <div className='flex'>
                    ...
                    <Link href="/contact">
                        <div className='ml-4 w-[125px] h-[40px] flex justify-center items-center rounded-full text-[#2e2e2e] text-[17px] font-semibold duration-150 ease-linear cursor-pointer bg-highlighte shadow-md hover:shadow-[#ffffff7b] active:scale-[1.025]'>Contact me</div>
                    </Link>
                </div>
            </div>
        </div>
